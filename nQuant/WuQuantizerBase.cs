...
namespace nQuant
{
    ...
    public abstract class WuQuantizerBase
    {
        ...
        public Image QuantizeImage(Bitmap image, int alphaThreshold, int alphaFader, int maxColors)
		{
            return QuantizeImage(image, alphaThreshold, alphaFader, null, maxColors);
		}
